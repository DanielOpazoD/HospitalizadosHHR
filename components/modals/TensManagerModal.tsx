            ...
            <div className="space-y-6">
                <div>
                    <div className="flex justify-between items-center mb-3">
                        ...
                        {syncing && (
                            <div className="flex items-center gap-1 text-[10px] text-teal-600 font-bold animate-pulse">
                                <Cloud size={12} />
                                SINCRONIZANDO...
                            </div>
                        )}
                        ...
                        <div className="flex gap-2">
                            <input
                                ...
                                className={clsx(
                                    ...
                                    validationError && !editingName ? "border-red-300 focus:ring-red-100" : "border-slate-200 focus:ring-teal-500"
                                )}
                            ...
                            <button
                                onClick={handleAdd}
                                className="bg-teal-600 hover:bg-teal-700 text-white p-2.5 rounded-xl transition-all shadow-lg shadow-teal-600/20 active:scale-95 flex items-center justify-center shrink-0"
                                disabled={syncing}
                            >
                                <Plus size={20} />
                            </button>
                    ...
                    <div className="space-y-2 max-h-[45vh] overflow-y-auto pr-1">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            <input
                                                className={clsx(
                                                    ...
                                                    validationError && editingName === tens ? "border-red-300 focus:ring-red-100" : "border-slate-200 focus:ring-teal-500"
                                                )}
                                                value={editValue}
                        ...
                        {tensList.length === 0 && (
                            <div className="text-center text-slate-400 text-sm py-10 italic bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                                No hay personal TENS registrado
                            </div>
                        )}
                    </div>
                </div>
